...
def test_load_tables_from_directory():
    ...
    assert len(table_service._tables) == 9  # incl. #tables and #columns
...
def test_table_get_item():
    ...
    assert table[1:5, "column_name"] == ["#columns.table_name", "#columns.column_name", "#columns.ordinal_position",
                                         "#columns.data_type"]
