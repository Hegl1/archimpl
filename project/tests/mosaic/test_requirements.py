...
@pytest.mark.parametrize(
    ...
    [
        ('sigma test != null and test <= 58237.5 pi test as (MatrNr * 2) - 5.0 / 2, test2 as null hoeren;',
         ['test', 'test2'], 10),
...
@pytest.mark.parametrize(
    ...
    [
        ('pi column_name, #columns.data_type, ordinal_position #columns;',
         ['#columns.column_name', '#columns.data_type', '#columns.ordinal_position'], 31),
        ('pi PersNr, Name, FullName as "Prof. " + professoren.Name, NewName as Name professoren;',
         ['professoren.PersNr', 'professoren.Name', 'FullName', 'NewName'], 7),
        ('sigma Rang > "C3" professoren;',
         ['professoren.PersNr', 'professoren.Name', 'professoren.Rang', 'professoren.Raum'], 4),
        ...
        (
        '#columns;', ['#columns.table_name', '#columns.column_name', '#columns.ordinal_position', '#columns.data_type'],
        31),
        ...
        ('sigma table_name = "pruefen" #columns;',
         ['#columns.table_name', '#columns.column_name', '#columns.ordinal_position', '#columns.data_type'], 4),
        ('sigma Rang = "C4" professoren;',
         ['professoren.PersNr', 'professoren.Name', 'professoren.Rang', 'professoren.Raum'], 4),
        ('sigma Rang = "C4" and Raum >= "3" professoren;',
         ['professoren.PersNr', 'professoren.Name', 'professoren.Rang', 'professoren.Raum'], 2),
        ('sigma Rang = "C4" or Name = "Kopernikus" professoren;',
         ['professoren.PersNr', 'professoren.Name', 'professoren.Rang', 'professoren.Raum'], 5),
        ('pi Name professoren union pi Name studenten;', ['professoren.Name'], 15),
        ('studenten cross join hoeren;',
         ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.MatrNr', 'hoeren.VorlNr'], 80),
        (
        ...
        ('sigma studenten.MatrNr = hoeren.MatrNr (studenten cross join hoeren);',
         ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.MatrNr', 'hoeren.VorlNr'], 10),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ('pi PersNr, Name professoren join professoren.PersNr = assistenten.Boss pi PersNr, Name, Boss assistenten;',
         ['professoren.PersNr', 'professoren.Name', 'assistenten.PersNr', 'assistenten.Name', 'assistenten.Boss'], 6),
        (
        'pi PersNr, Name professoren left join professoren.PersNr = assistenten.Boss pi PersNr, Name, Boss assistenten;',
        ['professoren.PersNr', 'professoren.Name', 'assistenten.PersNr', 'assistenten.Name', 'assistenten.Boss'], 9),
        ('pi VorlNr, Titel vorlesungen natural join pi VorlNr, MatrNr, Note pruefen;',
         ['vorlesungen.VorlNr', 'vorlesungen.Titel', 'pruefen.MatrNr', 'pruefen.Note'], 3),
        ('pi VorlNr, Titel vorlesungen natural left join pi VorlNr, MatrNr, Note pruefen;',
         ['vorlesungen.VorlNr', 'vorlesungen.Titel', 'pruefen.MatrNr', 'pruefen.Note'], 10),
        ('gamma Rang aggregate Anzahl as count(PersNr) professoren;', ['professoren.Rang', 'Anzahl'], 2),
        (
        'studenten natural join hoeren;', ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.VorlNr'],
        10),
        ('studenten natural left join hoeren;',
         ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.VorlNr'], 14),
        ('studenten left join studenten.MatrNr = hoeren.MatrNr hoeren;',
         ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.MatrNr', 'hoeren.VorlNr'], 14),
        ...
        ['AvgSemester', 'MinSemester', 'MaxSemester'], 1),
        ('sigma studenten.MatrNr = hoeren.MatrNr (studenten cross join hoeren);',
         ['studenten.MatrNr', 'studenten.Name', 'studenten.Semester', 'hoeren.MatrNr', 'hoeren.VorlNr'], 10),
        (
        ...
        ['hoeren.VorlNr', 'vorlesungen.Titel', 'vorlesungen.SWS', 'vorlesungen.gelesenVon'], 2)
    ],
)
